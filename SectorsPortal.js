...
const SectorsPostal = ({ visible, onClose, heading, listItems, SelectedFillterItem }) => {
                    ...
                    <ScrollView style={{ paddingVertical: 2 }}>
                        {listItems.map((item, index) => (
                            <TouchableOpacity activeOpacity={0.5} key={index}
                                ...
                                <Text style={styles.listText}>{item.sector}</Text>
                            </TouchableOpacity>
                        ))}
                    </ScrollView>
                </View>
...
const styles = StyleSheet.create({
    ...
    modalView: {
        ...
        maxHeight:DeviceDimentions.h/1.2
    },
    modalHeading: {
        fontWeight: '700',
